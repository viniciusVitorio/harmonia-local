<nav x-data="{ open: false }" class="sticky top-0 bg-white white:bg-gray-800 border-b border-gray-100 white:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}" class="text-[#4f46e5]">
                        <x-application-logo class="block h-9 w-auto fill-current text-black-800 white:text-black-200" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('addMusic')" :active="request()->routeIs('addMusic')">
                        {{ __('Adicionar música') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('addMusic')" :active="request()->routeIs('addMusic')">
                {{ __('Adicionar música') }}
            </x-responsive-nav-link>
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 white:border-gray-600">
            <div class="px-4">
                ...
                @else
                    <div class="font-medium text-base text-gray-800 white:text-gray-200">Guest</div>
